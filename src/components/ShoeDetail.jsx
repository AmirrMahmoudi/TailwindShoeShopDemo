...
const ShoeDetail = ({ shoe, onClickAdd }) => {
  ...
  return (
    <div className="flex select-none flex-col space-y-4 dark:text-white lg:flex-row-reverse">
      {/* Shoe image */}
      ...
      <div className="flex-1 space-y-6 ">
        ...
        <div className="space-x-10">
          <button
            ...
            className="btn-press-anim h-14 w-44 rounded bg-black text-white hover:bg-gray-900 active:bg-gray-700 dark:bg-white dark:text-black"
          >
            Add to bag
          </button>
          <a
